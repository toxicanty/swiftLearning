...
class ViewController: UIViewController {
    ...
    func setupUI()->(){
        ...
        // 1205 7:00 用自定义extension方法简化对象创建
        let textField1 = UITextField(frame: CGRect(x: 20, y: 20, width: 100, height: 30), placeholder: "0", fontsize: 17)
        view.addSubview(textField1)
        // 1205 7:00 用自定义extension方法简化对象创建
        let textField2 = UITextField(frame: CGRect(x: 140, y: 20, width: 100, height: 30), placeholder: "0", fontsize: 17)
...
//        label1.textAlignment = .center
        ...
        let label1 = UILabel(frame: CGRect(x: 120, y: 20, width: 20, height: 30), txt: "+")
...
//        label2.textAlignment = .center
        ...
        let label2 = UILabel(frame: CGRect(x: 260, y: 20, width: 20, height: 30), txt: "=")
...
//        label3.textAlignment = .center
        ...
        let label3 = UILabel(frame: CGRect(x: 280, y: 20, width: 60, height: 30), txt: "0")
...
//        btn.sizeToFit()
        ...
        let btn = UIButton(title: "计算",fontSize: 30.0) // color本身有默认值,可以不赋值
        //let btn = UIButton(title: "计算", color: UIColor.red, fontSize: 30)
